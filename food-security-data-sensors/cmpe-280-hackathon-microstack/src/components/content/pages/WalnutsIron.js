...
import csvFile from '../pages/data/walnuts-iran.csv';
...
const options = {
    ...
    title: {
        text: 'Iran(Islamic Republic Of)- walnuts, in shell, Production (tones) and Area Harvested (hectare)'
    },
    yaxis: [
        {
            title: {
...
class WalnutsIron extends Component {
    constructor(props) {
        super(props);
        this.state = {
            series: []
